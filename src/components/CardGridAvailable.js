...
import PollModal from './PollModal.js'; // Импортируем компонент модального окна
import _isEqual from 'lodash/isEqual';

function CardGridAvailable({ data, isLoading }) {
  ...
  }, [data, filteredPolls]); // Обновление useEffect при изменении data или filteredPolls
...
export default CardGridAvailable;
